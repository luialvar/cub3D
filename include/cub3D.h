...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/10 10:57:18 by luialvar          #+#    #+#             */
/*   Updated: 2025/08/10 10:57:20 by luialvar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		check_error_repetitions(int error,
			t_line_info *line_infos, char *name);
...
void	str_line(char *line, t_game_data *game_data,
			int *fd, int max_width_map);
